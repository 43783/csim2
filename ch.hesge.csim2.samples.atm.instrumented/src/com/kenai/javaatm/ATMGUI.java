...
public class ATMGUI extends javax.swing.JFrame {
    ...
    public ATMGUI() {
        try {
			ch.hesge.csim2.engine.TraceLogger.entering("com.kenai.javaatm",
					"ATMGUI#" + this.hashCode(), "com.kenai.javaatm", "ATMGUI#"
							+ this.hashCode(), "ATMGUI", "void", "void");
			initComponents();
			initOutComponents();
		} finally {
    ...
    private void initComponents() {
        ...
        try {
			ch.hesge.csim2.engine.TraceLogger
					.entering("com.kenai.javaatm", "ATMGUI#" + this.hashCode(),
							"com.kenai.javaatm", "ATMGUI#" + this.hashCode(),
			...
			jLabellogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/kenai/javaatm/icons/Credit-Card-Logos.png"))); // NOI18N
			...
			ch.hesge.csim2.engine.TraceLogger
					.exiting("com.kenai.javaatm", "ATMGUI#" + this.hashCode(),
							"com.kenai.javaatm", "ATMGUI#" + this.hashCode(),
							"initComponents", "void", "void");
		}
    ...
    private void initOutComponents() {
        ...
        try {
			ch.hesge.csim2.engine.TraceLogger.entering("com.kenai.javaatm",
					"ATMGUI#" + this.hashCode(), "com.kenai.javaatm", "ATMGUI#"
							+ this.hashCode(), "initOutComponents", "void",
					"void");
			...
			jPanelDepositSlotDraw("/com/kenai/javaatm/icons/DepositSlot.jpg");
			...
			jPanelInsertCardDraw("/com/kenai/javaatm/icons/InsertCard.jpg");
    ...
    public static void main(String args[]) {
        try {
			ch.hesge.csim2.engine.TraceLogger.entering("com.kenai.javaatm",
					"ATMGUI#0", "com.kenai.javaatm", "ATMGUI#0", "main",
					"String args", "void");
    ...
    public void jPanelDepositSlotDraw(String imgUrl) {
        try {
			ch.hesge.csim2.engine.TraceLogger.entering("com.kenai.javaatm",
					"ATMGUI#" + this.hashCode(), "com.kenai.javaatm", "ATMGUI#"
							+ this.hashCode(), "jPanelDepositSlotDraw",
					"String imgUrl", "void");
    ...
    public void jPanelInsertCardDraw(String imgUrl) {
        try {
			ch.hesge.csim2.engine.TraceLogger.entering("com.kenai.javaatm",
					"ATMGUI#" + this.hashCode(), "com.kenai.javaatm", "ATMGUI#"
							+ this.hashCode(), "jPanelInsertCardDraw",
					"String imgUrl", "void");
			ImageIcon img = new ImageIcon(getClass().getResource(imgUrl));
...
try {
    ...
    private void authenticateUser() {
        try {
			ch.hesge.csim2.engine.TraceLogger.entering("com.kenai.javaatm",
					"ATMGUI#" + this.hashCode(), "com.kenai.javaatm", "ATMGUI#"
							+ this.hashCode(), "authenticateUser", "void",
					"void");
...
try {
			ch.hesge.csim2.engine.TraceLogger.entering("com.kenai.javaatm",
					"ATMGUI#" + this.hashCode(), "com.kenai.javaatm", "ATMGUI#"
							+ this.hashCode(), "performTransactions", "void",
					"void");
...
try {
			ch.hesge.csim2.engine.TraceLogger.entering("com.kenai.javaatm",
					"ATMGUI#" + this.hashCode(), "com.kenai.javaatm", "ATMGUI#"
							+ this.hashCode(), "createTransaction", "int type",
					"Transaction");
    ...
    public static void delay(long ms) {
        try {
			ch.hesge.csim2.engine.TraceLogger.entering("com.kenai.javaatm",
					"ATMGUI#0", "com.kenai.javaatm", "ATMGUI#0", "delay",
					"long ms", "void");
			try {
			    Thread.sleep(ms);
