    ...
    public BalanceInquiry(int userAccountNumber, Screen atmScreen,
		...
		try {
			ch.hesge.csim2.engine.TraceLogger
					.entering(
							"com.kenai.javaatm",
							"BalanceInquiry#" + this.hashCode(),
							"com.kenai.javaatm",
							"BalanceInquiry#" + this.hashCode(),
							"BalanceInquiry",
							"int userAccountNumber,Screen atmScreen,BankDatabase atmBankDatabase,Keypad atmKeypad",
							"void");
			keypad = atmKeypad;
		} finally {
			ch.hesge.csim2.engine.TraceLogger
    ...
    public void execute() {
        try {
			ch.hesge.csim2.engine.TraceLogger.entering("com.kenai.javaatm",
					"BalanceInquiry#" + this.hashCode(), "com.kenai.javaatm",
					"BalanceInquiry#" + this.hashCode(), "execute", "void",
					"void");
