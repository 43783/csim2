...
public class MainView extends JFrame implements ActionListener {
	...
	private JCheckBoxMenuItem mnuProjectView;
	private JCheckBoxMenuItem mnuConsoleView;
	private JCheckBoxMenuItem mnuEngineView;
	...
	private DefaultCDockable consoleView;

	
	private DefaultCDockable projectDockable;
	*/
...
//		desktop.addDockable(projectView);		
		
		consoleView = new ConsoleView();
		desktop.addDockable(consoleView);		

//		engineView = new EngineView();
//		desktop.addDockable(engineView);		
		...
		//		// Create console view
		//		consoleView = new DefaultSingleCDockable("console", "Console");
		//		consoleView = new DefaultSingleCDockable("console", "Console");
		//		consoleView.setMinimizable(false);
		//		consoleView.setMaximizable(false);
		//		consoleView.setExternalizable(false);
		//		consoleView.setCloseable(true);
		//		consoleView.add(new ConsoleView());
		//		//dockGrid.add(40, 60, 100, 40, consoleView);
		...
		dockGrid = new CGrid(dockController);
		getContentPane().add(dockController.getContentArea(), BorderLayout.CENTER);
		...
		//dockController.getContentArea().deploy(dockGrid);
		
		dockController.addStation(dockGrid, true);
		*/
		//		// Initialize docking area
		...
		//		//dockGrid.add(40, 60, 100, 40, consoleView);
		//		
		//		dockControl.addDockable((SingleCDockable)consoleView);
...
//		engineView.setEngines(engineList);
	...
	private void initMenu() {
		...
		mnuProjectView = new JCheckBoxMenuItem("Project View");
		mnuProjectView.setSelected(true);
		mnuProjectView.addActionListener(this);
		mnuViews.add(mnuProjectView);
		
		mnuEngineView = new JCheckBoxMenuItem("Engines View");
		mnuEngineView.setSelected(true);
		mnuEngineView.addActionListener(this);
		mnuViews.add(mnuEngineView);

		mnuConsoleView = new JCheckBoxMenuItem("Console View");
		mnuConsoleView.setSelected(true);
		mnuProjectView.addActionListener(this);
		mnuViews.add(mnuConsoleView);
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (e.getSource() == mnuProjectView) {
			
			/*
			if (mnuProjectView.isSelected()) {
				
				dockGrid.add(0, 0, 40, 100, projectDockable);
				dockController.getContentArea().deploy(dockGrid);

				
				projectDockable.setVisible(true);
//				CContentArea station = dockController.getContentArea();
//				station.
//				dockController.getContentArea().to
//				dockController.addDockable("project", projectDockable);
//				dockGrid.add(0, 0, 40, 100, projectDockable);
			}
			else {
				dockGrid.add(0, 0, 40, 100, projectDockable);
				dockController.getContentArea().deploy(dockGrid);
				projectDockable.setVisible(false);
			}
			*/
		}
		else if (e.getSource() == mnuEngineView) {
			setProject(null);
		}
		else if (e.getSource() == mnuConsoleView) {
			setProject(null);
		}
