...
public class SourceMatcher implements IMethodConceptMatcher {
	...
	public Map<Integer, List<MethodConceptMatch>> getMethodMatchingMap(Project project) {
		...
		for (SourceMethod method : methodMap.values()) {
			for (Concept concept : conceptMap.values()) {
				...
				double similarity = getMethodConceptSimilarity(method, concept, stemMethodTreeMap, stemConceptTreeMap, matchinStemMethods, matchinStemConcepts);
	 ...
	 */
	private double getMethodConceptSimilarity(SourceMethod method, Concept concept, Map<Integer, StemMethod> stemMethodTreeMap, Map<Integer, StemConcept> stemConceptTreeMap, List<StemMethod> matchingStemMethods, List<StemConcept> matchingStemConcepts) {
