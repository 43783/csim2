...
public class TraceLogger {
	...
	private static void trace(int traceType, String staticPackageName, String staticClassName, String dynamicPackageName, String dynamicClassName, String methodName, String parameterTypes, String returnType) {
		...
		try {
			...
			String traceMessage = String.format((traceType == TRACE_ENTER ? TRACE_ENTER_FORMAT : TRACE_EXIT_FORMAT), timestamp, threadId, staticPackageName, staticClassName, dynamicPackageName, dynamicClassName, methodName, parameterTypes, returnType);
